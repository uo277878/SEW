class CalculadoraRPN{
    ...
    raiz(){
        if(this.pila.length >= 1){
            this.pila.push(Math.sqrt(Number(this.pila.pop())).toFixed(5));
        }
        this.puntoPulsado = false;
        document.querySelector('textarea').value = this.mostrar();
    }
    ...
    potencia2(){
        if(this.pila.length >= 1){
            this.pila.push(Math.pow(Number(this.pila.pop()),2).toFixed(5));
        }
        this.puntoPulsado = false;
        document.querySelector('textarea').value = this.mostrar();
    }
    ...
    log(){
        if(this.pila.length >= 1){
            this.pila.push(Math.log10(Number(this.pila.pop())).toFixed(5));
        }
        this.puntoPulsado = false;
        document.querySelector('textarea').value = this.mostrar();
    }
    ...
    ln(){
        if(this.pila.length >= 1){
            this.pila.push(Math.log(Number(this.pila.pop())).toFixed(5));
        }
        this.puntoPulsado = false;
        document.querySelector('textarea').value = this.mostrar();
    }
